...
<html lang="en">
  ...
  <footer id="footer">
   ...
   <div class="imgbox"><img alt="" src="img/updatelogo2.jpg"  style="width: 200px; ,height: 100px;" ></div>
   <div class="imgboxdiv"><div class="imgclass"><img alt="" src="img/phoneicon.svg" ></div><div class="imgtext">010-7548-6124</div></div>
   <div class="imgboxdiv"><div class="imgclass1"><img alt="" src="img/emailicon.svg" ></div><div class="imgtext1">BusanIT@naver.com</div></div></div>
